...
INSERT INTO PessoaFisica VALUES (1, 'João Pedro', 12345678910, 'Bosque Sul, 333', '11137564556'),
								(2, 'José Antonio', 08975386541, 'João XXIII, 17', '11997665745'),
                                (3, 'Rafael', 78531297453, 'Rua 2', '11091184726'),
                                (4, 'Edilberto', 89674435241, 'Reparação, 13', '11997674632'),
                                (5, 'Ana Caroline', 90877865576, 'Angélica, 7', '11976556477'),
                                (6, 'Maria Quitéria', 07795647385, 'Frei Serafim, 25', '11999098896');
...
INSERT INTO Mecanico VALUES	(1, 'Jorjão', 'Rua Alta', 'Borracharia'),
							(2, 'Alemão', 'Esquina com a primeira', 'Eletricista'),
                            (3, 'Zézinho', 'Virtude, 555', 'Qualquer tipo de reparo'),
                            (4, 'Zé Mareta', 'Rua dos Girassois, 1', 'Funilaria'),
                            (5, 'Ricardo', 'Rua plenitude, 54', 'Eletricista'),
                            (6, 'Bituca', 'Av. Miguel Rosa', 'Motor');
